...
function pasarUsuarioAPremium(usuarios) {
  ...
  // Tu código:
/* Usuario = [
    {name: "Mauricio", apellido: "Cuello", esPremium: false},
    {name: "Leo", apellido: "Messi", esPremium: true},
    {name: "Dani", apellido: "kk", esPremium: true}
]
*/
...
function sumarLikesDeUsuario(usuario) {
  ...
  usuario = {
    name: "Niko",
    apellido: "niko",
    posts: [{fecha: 12-12-12, likes: 10},
            {fecha: 11-11-11, likes: 5},
            {fecha: 10-10-10, likes: 15}
          ]
          resultado = 0 para que no altere a la suma ni resultado final.
          */
var resultado = 0;
